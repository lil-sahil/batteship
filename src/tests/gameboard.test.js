...
test("Place ship vertically out of board", () => {
  ...
  game.createGameboard();
  let ship = shipFactory(3);
  expect(game.placeShip(9, 0, ship, "vertical")).toBe(false);
});
...
test("Place ship vertically in in-accesible position", () => {
  ...
  expect(game.placeShip(1, 0, ship2, "vertical")).toBe(false);
});
...
test("Place ship horizontaly out of board", () => {
  ...
  expect(game.placeShip(9, 9, ship, "horizontal")).toBe(false);
});
...
test("Place ship horizontaly in in-accesible position", () => {
  ...
  expect(game.placeShip(0, 1, ship2, "horizontal")).toBe(false);
});
